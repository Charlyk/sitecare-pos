...
**Plans**: 5 plans
- [ ] 09-01-PLAN.md — pure derivation layer: preset range builders, 366-day span validator, input→query converter, locale-aware range formatter (history-utils.js)
- [ ] 09-02-PLAN.md — 8 new i18n keys (ro+en) + h_empty rename to h_empty_prefix; spin keyframe
- [ ] 09-03-PLAN.md — parameterize useHistoryOrders({from,to}) + keepPreviousData; rewrite frozen-at-mount tests
- [ ] 09-04-PLAN.md — live preset pills, dimmed-loading + spinner (D-05), settled-label tracking (D-06), period copy fix (D-12/D-13)
