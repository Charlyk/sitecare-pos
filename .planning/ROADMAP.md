...
- [x] 17-01-PLAN.md — Tracer: central 403 choke-point wiring (main.jsx QueryCache/MutationCache onError → handleBranchError) proven end-to-end for BRANCH_ACCESS_REVOKED

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 17-02-PLAN.md — Live 403-envelope verification: capture real REST + SSE 403 body shapes, lock/correct the matcher (autonomous: false)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 17-03-PLAN.md — Complete handleBranchError (all 3 codes) + noBranchAccess store flag + D-05 no-double-toast guard
...
| 17. Centralized Branch-Access Error Handling | v1.2 | 3/6 | In Progress|  |
