...
export const I18N = {
  ro: {
    ...
    h_diag_prefix: 'Detalii tehnice:',
    h_diag_probe_ok: 'Test cu interval redus (Azi): reușit — problema pare legată de dimensiunea răspunsului.',
    h_diag_probe_fail: 'Test cu interval redus (Azi): eșuat —',
    h_retry: 'Reîncearcă',
  ...
  en: {
    ...
    h_diag_prefix: 'Technical details:',
    h_diag_probe_ok: 'Small-range test (Today): succeeded — issue appears related to response size.',
    h_diag_probe_fail: 'Small-range test (Today): failed —',
    h_retry: 'Retry',
